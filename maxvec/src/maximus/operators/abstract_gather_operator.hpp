...
class AbstractGatherOperator : public AbstractOperator {
public:
    AbstractGatherOperator(std::shared_ptr<MaximusContext>& ctx,
...
protected:
    std::shared_ptr<GatherProperties> properties;
    std::vector<DeviceTablePtr> input_tables_;
    int inputs_received_ = 0;
};
