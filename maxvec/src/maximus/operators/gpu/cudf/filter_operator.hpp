...
class FilterOperator
        : public maximus::AbstractFilterOperator
...
private:
    std::list<std::shared_ptr<::cudf::ast::expression>> expression_list;
    std::list<std::shared_ptr<::cudf::scalar>> scalar_list;
    std::list<maximus::gpu::ExtExpression> ext_map;
