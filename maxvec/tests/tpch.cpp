...
TEST(TPCH, Q17) {
    ...
    ctx->fusing_enabled = false;

    auto db_catalogue = maximus::make_catalogue(path);
    auto db           = maximus::make_database(db_catalogue, ctx);

    auto q17 = maximus::tpch::q17(db);
